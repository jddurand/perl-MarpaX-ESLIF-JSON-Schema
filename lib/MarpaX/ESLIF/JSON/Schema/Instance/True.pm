...
package MarpaX::ESLIF::JSON::Schema::Instance::True;

# ABSTRACT: JSON Schema True Instance
...
use overload (
              fallback => 1,
              '""'     => \&_stringify,
              '=='     => sub { my $rc = _equal(@_); print STDERR $rc ? "TRUE OK\n" : "TRUE DIFFER\n"; $rc },
              'eq'     => sub { my $rc = _equal(@_); print STDERR $rc ? "TRUE OK\n" : "TRUE DIFFER\n"; $rc }
             );
